...
namespace LiveMarkdown.Controls.Mermaid
{
    public class MermaidViewer : UserControl
    {
        ...
        // Publiczne wywo�anie wy�rodkowania na ��danie
        ...
        {
            // Usuni�to ograniczanie offsetu, aby umo�liwi� swobodne przesuwanie widoku
            _offset = offset;
            SetTransforms();
        }
        ...
        // Upublicznij FitToView, aby mo�na by�o wywo�a� j� z zewn�trz
        public void FitToView()
        {
            // Spr�buj dopasowa� diagram do widoku
        ...
        private void OpenInNewWindow()
        {
            ...
            win.Opened += (_, _) =>
            {
                if (win.Content is MermaidViewer viewer)
                    viewer.FitToView(); // wy�rodkuj po otwarciu
            };
